...
throw new ArithmeticException("Numero Excedido ");
 ...
 this.Compras.remove(Compra);
  ...
  p.setCantidad((p.getCantidad())+1);
    ...
    public void cargarcarrito(CarritoDeCompras carrito)throws FileNotFoundException{
       CarritoDao cdao= new CarritoDao();
       cdao.guardarcarrito(carrito);
    }
    public ArrayList<String> leercarrito()throws FileNotFoundException{
       CarritoDao cdao= new CarritoDao();
       ArrayList<String> car=cdao.lecturacarrito();
       return car;
    }
